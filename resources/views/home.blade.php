          ...
          <div class="row">
             ...
             <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="box">
                   ...
                   <div class="img-box">
                      <img src="{{asset('Template/images/p4.png')}}" alt="">
                   </div>
                   <div class="detail-box">
                      <h5>
                         Women's Dress
             ...
             <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="box">
                   ...
                   <div class="img-box">
                      <img src="{{asset('Template/images/p7.png')}}" alt="">
                   </div>
                   <div class="detail-box">
                      <h5>
                         Women's Dress
             ...
             <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="box">
                   ...
                   <div class="img-box">
                      <img src="{{asset('Template/images/p10.png')}}" alt="">
                   </div>
                   <div class="detail-box">
                      <h5>
                         Men's Shirt
             ...
             <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="box">
                   ...
                   <div class="img-box">
                      <img src="{{asset('Template/images/p11.png')}}" alt="">
                   </div>
                   <div class="detail-box">
                      <h5>
                         Men's Shirt
             ...
             <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="box">
                   ...
                   <div class="img-box">
                      <img src="{{asset('Template/images/p12.png')}}" alt="">
                   </div>
                   <div class="detail-box">
                      <h5>
                         Women's Dress
